...
namespace GTRC_Database_API.Services
{
        ...
        IBaseContext<Bop> iBaseContext) : BaseService<Bop>(iBaseContext)
    {
        ...
        public async Task<bool> ValidateUniqProps(Bop? obj)
        {
            bool isValidUniqProps = true;
            if (obj is null) { return false; }

            obj.Name = Scripts.RemoveSpaceStartEnd(obj.Name);
            if (obj.Name == string.Empty) { obj.Name = Bop.DefaultName; isValidUniqProps = false; }
        ...
        public async Task<Bop?> GetTemp() { Bop obj = new(); await ValidateUniqProps(obj); return obj; }
    }
}
