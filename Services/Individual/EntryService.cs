...
namespace GTRC_Database_API.Services
{
        ...
        IBaseContext<Entry> iBaseContext) : BaseService<Entry>(iBaseContext)
    {
        ...
        public async Task<List<Entry>> UpdateRaceNumbers(int seasonId) // Not yet implemented: Nur Meister der Vorsaison darf #1 haben
        {
            ...
            DateTime seasonStartDate = (await seasonService.GetDateFirstEvent(seasonId)) ?? DateTime.MaxValue;
            ...
            {
                DateTime previousSeasonStartDate = (await seasonService.GetDateFirstEvent(seasons[index].Id)) ?? DateTime.MaxValue;
