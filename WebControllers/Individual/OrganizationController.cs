...
namespace GTRC_Database_API.Controllers
{
    ...
    public class OrganizationController(OrganizationService service, BaseService<Organization> baseService) : BaseController<Organization>(baseService)
    {
        ...
        {
            Organization? objValidated = service.Validate(objDto.Dto2Model());
            Organization? obj = await service.SetNextAvailable(objDto.Dto2Model());
        ...
        [HttpPut("Update")] public async Task<ActionResult<Organization?>> Update(OrganizationUpdateDto objDto)
        {
            ...
            {
                Organization? objValidated = service.Validate(objDto.Dto2Model(obj));
