...
namespace GTRC_Database_API.Controllers
{
    ...
    public class EventCarclassController(EventCarclassService service, BaseService<EventCarclass> baseService) : BaseController<EventCarclass>(baseService)
    {
        ...
        {
            EventCarclass? objValidated = service.Validate(objDto.Dto2Model());
            EventCarclass? obj = await service.SetNextAvailable(objDto.Dto2Model());
        ...
        [HttpPut("Update")] public async Task<ActionResult<EventCarclass?>> Update(EventCarclassUpdateDto objDto)
        {
            ...
            {
                EventCarclass? objValidated = service.Validate(objDto.Dto2Model(obj));
