...
namespace GTRC_Database_API.Controllers
{
    ...
    public class ManufacturerController(ManufacturerService service, BaseService<Manufacturer> baseService, FullService<Manufacturer> fullService) : BaseController<Manufacturer>(baseService, fullService)
    {
        ...
        {
            Manufacturer? obj = objDto.Dto2Model();
        ...
        [HttpPut("Update")] public async Task<ActionResult<Manufacturer?>> Update(ManufacturerUpdateDto objDto)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    await fullService.UpdateChildObjects(typeof(Manufacturer), obj);
                    return Ok(obj);
                }
            }
        }
