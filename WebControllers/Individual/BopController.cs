...
namespace GTRC_Database_API.Controllers
{
    [ApiController]
    [Route(nameof(Bop))]
    public class BopController(BopService service, BaseService<Bop> baseService, FullService<Bop> fullService) : BaseController<Bop>(baseService, fullService)
    {
        ...
        [HttpPut("Update")] public async Task<ActionResult<Bop?>> Update(BopUpdateDto objDto)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    await fullService.UpdateChildObjects(typeof(Bop), obj);
                    return Ok(obj);
                }
            }
        }
